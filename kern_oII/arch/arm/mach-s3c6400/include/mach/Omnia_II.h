...
//#define GPIO_WLAN_CMD
//#define GPIO_WLAN_CLK
//#define GPIO_WLAN_WAKE
...
#define GPIO_CP_BOOT_SEL	GPIO_ALS_EN
#define GPIO_CP_BOOT_SEL_AF	GPIO_ALS_EN_AF

#define GPIO_BT_HOST_WAKE	GPIO_BT_WAKE
#define GPIO_BT_HOST_WAKE_AF	GPIO_BT_WAKE_AF
