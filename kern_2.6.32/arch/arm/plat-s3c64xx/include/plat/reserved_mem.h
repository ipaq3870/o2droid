...
//3+6+6+3+2+6=28M
#define RESERVED_G3D_SHARED		(RESERVED_MEM_CMM + RESERVED_MEM_MFC + RESERVED_PMEM_STREAM + RESERVED_PMEM_JPEG + RESERVED_PMEM_PREVIEW + RESERVED_PMEM_RENDER) //21
#define RESERVED_G3D_APP		(RESERVED_G3D - /*RESERVED_G3D_UI*/ - RESERVED_G3D_SHARED) //32-26=6m //THIS IS ONLY FOR UNDERSTANDING PURPOSES, DOESNT DO ANYTHING
